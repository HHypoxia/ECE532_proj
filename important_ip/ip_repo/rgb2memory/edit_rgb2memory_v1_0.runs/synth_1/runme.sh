...
HD_PWD='D:/vivadoproject/project532/important_ip/ip_repo/rgb2memory/edit_rgb2memory_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2memory_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2memory_v1_0.tcl
